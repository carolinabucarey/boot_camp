...
window.SITE_CONTENT = {
  ...
  people: [
    ...
    },
    {
      ...
      bio: "**Ingeniera química** de la Universidad Nacional de Ingeniería, con diplomatura en gestión de proyectos de la Pontificia Universidad Católica del Perú y un **MBA en curso en ESAN**. Fundadora y CEO de **KUIDDA**, empresa peruana que desarrolla **agentes de inteligencia artificial** para seguridad urbana. Formula proyectos de innovación que han **ganado fondos públicos** y enseña en aulas universitarias y técnicas. En los talleres acompaña a las participantes a construir su propio proyecto, con la experiencia de quien construye agentes todos los días. Desde 2019 lidera además un **proyecto de empoderamiento con alumnas de secundaria** en Huachipa: acercar la tecnología a más mujeres es algo que hacía mucho antes de que existiera esta iniciativa.",
