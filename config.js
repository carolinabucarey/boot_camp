  ...
  people: [
    {
      ...
      bio: "**Ingeniera civil industrial** de la Universidad de Santiago y **MBA del IE Business School**, con **quince años** liderando estrategia, operaciones y productos digitales en América Latina. Fundadora y CEO de **Savia**, que ayuda a profesionales y organizaciones a llevar la inteligencia artificial a su trabajo diario, y cofundadora de **Tripsy**, empresa chilena respaldada por **Start-Up Chile** que ha **ganado fondos públicos**. Su trayectoria pasa por **McKinsey, DiDi y Groupon**. Impulsa esta iniciativa para abrir más espacio a las mujeres que quieran construir y liderar en tecnología.",
    ...
    },
    {
      ...
      bio: "**Ingeniera química** de la Universidad Nacional de Ingeniería, con diplomatura en gestión de proyectos de la Pontificia Universidad Católica del Perú y un **MBA en curso en ESAN**. Fundadora y CEO de **KUIDDA**, empresa peruana respaldada por **Start-Up Chile** que desarrolla **agentes de inteligencia artificial** para seguridad urbana. Formula proyectos de innovación que han **ganado fondos públicos** y enseña en aulas universitarias y técnicas. En los talleres acompaña a las participantes a construir su propio proyecto, con la experiencia de quien construye agentes todos los días. Desde 2019 lidera además un **proyecto de empoderamiento con alumnas de secundaria** en Huachipa: acercar la tecnología a más mujeres es algo que hacía mucho antes de que existiera esta iniciativa.",
